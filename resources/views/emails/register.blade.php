...
<html>
  <head>
    ...
    <title>{{ 'Notificaciones Anuncios' }}</title>
    <style>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                          ...
                          <h1 style="font-family: sans-serif; font-size: 18px; font-weight: normal; margin: 0; Margin-bottom: 15px; color:#009f8b; ">{{ 'Nueva Cuenta' }}</h1>
                          ...
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                            {{ $subtitle or 'Tu nueva cuenta esta lista para ser usada. solo debes ingresar con tu correo electronico y tu contraseña. Muchas gracias por elegir nuestros servicios.' }}
                          </p>
